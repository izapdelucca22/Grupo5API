...
public class Usuario implements UserDetails, Serializable {
    ...
    public void setUsuarioPerfis(Set<UsuarioRelationship> usuarioPerfis) {
        this.usuarioRelacoes = usuarioPerfis;
    }
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        ...
        for (UsuarioRelationship usuarioRelacoes : usuarioRelacoes) {
            authorities.add(new SimpleGrantedAuthority(usuarioRelacoes.getRelationship().getId().toString()));
        }
        return authorities;
    }
